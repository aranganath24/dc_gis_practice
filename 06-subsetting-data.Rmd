...
But it's important to emphase that while a single row will be a data frame, a single column will be extracted as a vector (but you can change that if you'd like by setting ```drop=FALSE```)
