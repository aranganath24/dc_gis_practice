...
This brings us to another important data structure, which is called a factor. Factors look like character data, but are used to represent categorical information. For example, let's make a vector of strings labeling nordic countries for all the countries in the study:
...
# Then let's convert this character vector into a factor, and specify the levels such that "control"
...
We can also extract through an alternative notation that specifies the column's index:
